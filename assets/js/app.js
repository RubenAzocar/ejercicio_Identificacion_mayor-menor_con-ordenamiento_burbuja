...
for (let i = 0; i < numerosLista; i++) {
    ...
    // Number.parseFloat() convierte el texto ingresado a número decimal
...
do {
    ...
    // Compara cada elemento con el anterior (j-1)
...
const menor = lista[0];
// El último elemento con .at(-1) es el número mayor
